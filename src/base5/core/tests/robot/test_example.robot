...
#
#  $ bin/test -s base5.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src base5.core.testing.BASE5_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/base5/core/tests/robot/test_example.robot
#
