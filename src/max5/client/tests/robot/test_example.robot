...
#
#  $ bin/test -s max5.client -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src max5.client.testing.MAX5_CLIENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/max5/client/tests/robot/test_example.robot
#
